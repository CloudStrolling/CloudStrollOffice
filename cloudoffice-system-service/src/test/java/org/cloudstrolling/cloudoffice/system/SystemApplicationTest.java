...
class SystemApplicationTest {
    ...
    void contextLoads_shouldLoadSuccessfully_whenApplicationStarts() {
        ...
        // 若测试方法执行成功，说明上下文加载正常
        assertNotNull(SystemApplication.class);
    }
    ...
    void enableDiscoveryClient_shouldBePresent_whenAnnotationCheck() {
        ...
        EnableDiscoveryClient annotation = SystemApplication.class.getAnnotation(EnableDiscoveryClient.class);

        // Then: 注解应存在
        assertNotNull(annotation, "SystemApplication 应标注 @EnableDiscoveryClient 注解");
    }
}
