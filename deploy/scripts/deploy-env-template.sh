...
# 版本: v0.1.7
# 说明: 【已弃用】请改用 deploy 目录下的 env.json 配置文件
#       复制 deploy/env.example.json 为 deploy/env.json，修改配置值，
#       然后运行脚本时通过 deploy/scripts/load-env.sh 自动加载
# ============================================================
...
# 生成方式: ./deploy/scripts/deploy-rsa-keygen.sh
