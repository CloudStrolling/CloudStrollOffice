...
.DESCRIPTION
  ...
  前置条件: 已执行 deploy/scripts/deploy-env-local.ps1
.EXAMPLE
  .\deploy\scripts\deploy-start-gateway.ps1
#>

$ProjectDir = Split-Path -Parent $PSScriptRoot
$JarPath = Join-Path $ProjectDir "cloudoffice-gateway.jar"
